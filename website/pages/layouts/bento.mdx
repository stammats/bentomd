...
Standard Markdown tables work inside any cell:
...
Use `>` for pull quotes inside cells:
...
### :message-circle: Customer Feedback
> "This tool changed how our team builds presentations. We ship decks 10x faster now."

### :star: Press Review
> "The most elegant Markdown-to-slides tool we've seen. Bento grid layout is genius."

### :heart: Community
> "Finally, a presentation tool that respects plain text and version control."`} />
...
- Any Markdown content works inside cells: bold, italic, links, lists, tables, quotes, code blocks, and mermaid diagrams
